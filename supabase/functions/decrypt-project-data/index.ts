// Supabase Edge Function: decrypt-project-data
// 解密项目数据
...
serve(async (req) => {
  ...
  try {
    ...
    const projectName = decryptText(encryptedProjectName || '', encryptionKey)
    const description = decryptText(encryptedDescription || '', encryptionKey)
